"""
build_patches_fire_Anthropogenic_use.py

Description
-----------
Block-wise extraction of burned patches from annual burned-area rasters
for ANTHROPOGENIC USE, exporting one CSV per year with patch-level
centroids and area.

Inputs
------
- One GeoTIFF per year in RASTER_FOLDER, e.g.:
    fogo_antropico_1985.tif
    fogo_antropico_1986.tif
    ...
...
# Example: 'E:/Process/Antropico' or a Google Drive mount
RASTER_FOLDER = r"E:/Process/Antropico"
